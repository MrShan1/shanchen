...
VirtualizationTool.prototype.init = function () {
    try {
        ...
        //为恢复操作按钮关联点击事件
        if (config.buttonTool.undoId !== null) {
            var redoOperation = this.redoOperation;
            var getNodesNum = this.getNodesNum;
            var getLinksNum = this.getLinksNum;

            this.addClickEventForController(config.buttonTool.undoId,
                function () {
                    redoOperation.excute();
                    getNodesNum.excute(config.dataTool.nodeNumId);
                    getLinksNum.excute(config.dataTool.linkNumId);
                });
        }
        ...
        //为适应屏幕按钮关联点击事件
        if (config.buttonTool.fitToScreenId !== null) {
            var fitToScreen = this.fitToScreen;

            this.addClickEventForController(config.buttonTool.fitToScreenId,
                function () {
                    fitToScreen.excute();
                });
        }
        ...
        //为选择居中按钮关联点击事件
        if (config.buttonTool.centerSelectionId !== null) {
            var centerSelection = this.centerSelection;
            this.addClickEventForController(config.buttonTool.centerSelectionId,
                 function () {
                     centerSelection.excute();
                 });
        }

        //为集中分析按钮关联点击事件
        if (config.buttonTool.analysisSelectionId !== null) {
            var analysisSelection = this.analysisSelection;
            this.addClickEventForController(config.buttonTool.analysisSelectionId,
                function () {
                    analysisSelection.excute();
                });
        }

        //为显示放大镜按钮关联点击事件
        if (config.switchTool.showMagnifierId !== null) {
            var showOverview = this.showOverview;
            this.addClickEventForController(config.switchTool.showMagnifierId,
                function () {
                    showOverview.excute(config.switchTool.showMagnifierId);
                });
        }
...
//撤销操作
VirtualizationTool.prototype.redoOperation = {
    canExcute: false,
    excute: function () {
        if (!this.canExcute) {
            return;
...
//适应屏幕
VirtualizationTool.prototype.fitToScreen = {
    canExcute: false,
    excute: function () {
        if (!this.canExcute) {
            return;
...
//选择居中
VirtualizationTool.prototype.centerSelection = {
    canExcute: false,
    excute: function () {
        if (!this.canExcute) {
            return;
...
//集中分析
VirtualizationTool.prototype.analysisSelection = {
    canExcute: false,
    excute: function () {
        if (!this.canExcute) {
            return;
...
//高亮直接关系
VirtualizationTool.prototype.highlightedRelation = {
    canExcute: false,
    isSwitchOn: false,
    toggleSwitch: function () {
        this.isSwitchOn = !this.isSwitchOn;
...
//布局集合
VirtualizationTool.prototype.Layouts = [
    { Name: "树形布局", Value: "TreeLayout" },
    { Name: "力导向布局", Value: "ForceDirectedLayout" },
    { Name: "环形布局", Value: "CircularLayout" },
    { Name: "分层有向布局", Value: "LayeredDigraphLayout" },
    { Name: "网格布局", Value: "GridLayout" }
];
