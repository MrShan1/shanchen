...
namespace ChenRui.SL.Diagram.Layout
{
    ...
    /// 弓形布局
    /// </summary>
    public class BowLayout : OldCustomizedLayout, ISpecialNodes
    {
        /// <summary>
        /// 特殊点提供者
        /// </summary>
        ...
        /// 标识ColumnCount依赖属性
        /// </summary>
        public static readonly DependencyProperty ColumnCountProperty = DependencyProperty.Register("ColumnCount", typeof(int), typeof(BowLayout), new PropertyMetadata(0, OnPropertyChanged));
        ...
        /// 标识RowCount依赖属性
        /// </summary>
        public static readonly DependencyProperty RowCountProperty = DependencyProperty.Register("RowCount", typeof(int), typeof(BowLayout), new PropertyMetadata(0, OnPropertyChanged));
        ...
        /// </summary>
        public static readonly DependencyProperty CenterNodePlacementProperty = DependencyProperty.Register("CenterNodePlacement", typeof(EnumCenterNodePlacement), typeof(BowLayout), new PropertyMetadata(EnumCenterNodePlacement.Left, OnPropertyChanged));
        ...
        /// </summary>
        public static readonly DependencyProperty CenterNodeDistanceProperty = DependencyProperty.Register("CenterNodeDistance", typeof(double), typeof(BowLayout), new PropertyMetadata(50.0, OnPropertyChanged));
        ...
        private Size DoLayout(IEnumerable<Node> nodes, Point? location)
        {
            ...
            nodes.ForEach(n =>
            {
                ...
                Locate(n, (ActualCellSize.Width / 2 + (ActualCellSize.Width + Spacing.Width) * (index % columnCount) - size.Width / 2) * (c % 2 == 0 ? 1 : -1), ActualCellSize.Height / 2 + (ActualCellSize.Height + Spacing.Height) * c - size.Height / 2, location);
                index++;
            });
            return size;
        }
